...
# from database.db import init_db
# from datetime import datetime
# from models.user_query import user_query_bp
...
# # Colab API URL for summarization (updated with new ngrok URL)
# COLAB_API_URL = "https://3007-34-16-225-226.ngrok-free.app/summarize-pdf"

# # Proxy endpoint to forward summarization requests to Colab
...
#     try:
#         # Prepare the file and form data to send to Colab
#         files = {'file': (file.filename, file.stream, file.content_type)}
#         data = {'word_limit': word_limit}
#         headers = {'X-API-Key': os.getenv('COLAB_API_KEY', 'abc123xyz789')}

#         # Send request to Colab API
#         response = requests.post(COLAB_API_URL, files=files, data=data, headers=headers)

#         # Return the Colab API's response
